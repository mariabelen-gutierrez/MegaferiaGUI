...
public class GerenteController {
     public static Response addGerente(String idtxt, String firstName, String lastName) {
        PersonaStorage personaRegister = PersonaStorage.getInstance();
        ArrayList<Person> gerentes = personaRegister.getPersonas();
        try {
            long id;
            try {
